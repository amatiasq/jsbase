...
(function() {
	...
	Base.extendFrom = function(clazz) {
		if (Object.getPrototypeOf(clazz.prototype)) !== Object.prototype)
			throw new Error("This only works with objects who directly inherits from Object");

		return this.extend(clazz.prototype);
	};
